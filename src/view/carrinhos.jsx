...
export default function Favoritos({  }) {
    ...
    useEffect(() => {
            const carts = userController.getCarrinho();
    setCarrinho(carts);
    }, [userController]);
    ...
    return (
        ...
        <ViewBase tabAtiva = {tabAtiva}>
            ...
            <View style={styles.content}>
                {carrinho.length > 0 ? (
                    ...
                    <View style={styles.emptyFavoritos}>
                        ...
                        <Text style={styles.emptyFavoritosText}>Seu carrinho está vazio</Text>
            ...
            {
                carrinho.length > 0 ? <TouchableOpacity style={styles.removeFavoritos}>
